  ...
  return (
    ...
    <div>
      <div className="relative">
        ...
        w-full transition-all duration-[10s] ${loading ? 'w-full transition-all duration-[10s]' : 'w-0'}`}/>
      </div>
...
{!isImageLoaded && 
    <div className="flex w-full max-w-xl text-white bg-neutral-500 
  ...
  {isImageLoaded && 
    ...
    rounded-full">
      <p onClick={()=>(setIsImageLoaded(false))} className="bg-transparent border border-zinc-900 text-black px-8 py-3 
