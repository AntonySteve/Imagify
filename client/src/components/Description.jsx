...
const Description = () => {
  return (
    ...
    viewport={{ once:true }}
    className='flex flex-col items-center justify-center my-20 p-6 mx-20
    md:px-28'>
      ...
      items-center'>
        ...
        <div>
            ...
            <p className='text-gray-600 mb-4'>Easily bring your ideas to life with our free AI image 
                ...
                our tool transforms your text into eye-catching images with just a
                few clicks. Imagine it, describe it, and watch it come to life instantly.
            </p>
            <p className='text-gray-600'>
                Simple type in a text promps, and our cutting edge AI will
                generate high-quality images in seconds. From product visuals
                to character designs and portraits,even concepts that don't yet exist
